...
def get_args():
    parser = argparse.ArgumentParser(description="Generate HAM10000 descriptions using various LLMs")
    parser.add_argument(
        "--model",
        type=str,
        default="phi3",
...
def main():
    ...
    input_file = "./data/HAM10000/labels.txt"
    output_file = f"./data/HAM10000/class_descriptions_{args.model}.json"
